...
public class MainActivity11 extends AppCompatActivity  implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(MainActivity11.this,NotesActivity.class);
    ...
    private void updateRecycler(List<Notes> notes) {
        ...
        notesListAdapter=new NotesListAdapter(MainActivity11.this,notes,notesClick);
        ...
        switch (item.getItemId()){
            case R.id.pin:
                if (selected_notes.isPinned()){
                    ...
                    Toast.makeText(this, "Event Unpinned", Toast.LENGTH_SHORT).show();
                }
                else {
                    database.dao().pin(selected_notes.getID(),true);
                    Toast.makeText(this, "Event Pinned", Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.del:
                ...
                notesListAdapter.notifyDataSetChanged();
                Toast.makeText(this, "Event Deleted Successful\n", Toast.LENGTH_SHORT).show();
                return  true;
            default:
                return false;
