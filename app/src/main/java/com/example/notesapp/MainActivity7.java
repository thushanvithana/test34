...
public class MainActivity7 extends AppCompatActivity  implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(MainActivity7.this,NotesActivity.class);
    ...
    private void updateRecycler(List<Notes> notes) {
        ...
        notesListAdapter=new NotesListAdapter(MainActivity7.this,notes,notesClick);
